...
public class Winter_internship {
	 ...
	 private String document_cretae_date;
	 private String document_cretae_date1;
	...
	public String getDocument_cretae_date() {
		return document_cretae_date;
	}
	public void setDocument_cretae_date(String document_cretae_date) {
		this.document_cretae_date = document_cretae_date;
	}
	public String getDocument_cretae_date1() {
		return document_cretae_date1;
	}
	public void setDocument_cretae_date1(String document_cretae_date1) {
		this.document_cretae_date1 = document_cretae_date1;
	}
